...
<<<<<<< HEAD
			...
			#f1.write(re.sub('  ',' ', x[2]+' <strong><RUBY><ruby><ruby>'+x[3]+'<rt>'+x[8]+'</rt></ruby><rt>'+x[6]+'∙'+x[12]+'</rt></ruby><rt>'+x[7]+'</rt></RUBY></strong>'+x[4]+x[5]))
			#f2.write(re.sub('  ',' ', x[2]+' <strong><RUBY><ruby><ruby>'+x[3]+'<rt>'+x[9]+'</rt></ruby><rt>'+x[6]+'∙'+x[12]+'</rt></ruby><rt>'+x[7]+'</rt></RUBY></strong>'+x[4]+x[5]))
		else:
